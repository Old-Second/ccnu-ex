...
#countrys>*[level="5"]{fill:#028ac8;}
#countrys>*[level="4"]{fill:#028ac8;}
#countrys>*[level="3"]{fill:#fe530b;}
#countrys>*[level="2"]{fill:#fbc643;}
#countrys>*[level="1"]{fill:#fff4d6;}
...
const reader = async _ => {
    ...
    let xml = readFileSync('ccnu-ex.svg', 'utf8');

    xml = replaceSVG(xml);
    writeFileSync('ccnu-ex-fixed.svg', xml);
    ...
    let jsText = readFileSync('html/script.js', 'utf8');
